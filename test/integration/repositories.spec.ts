...
import { startDynamoTestHarness, type DynamoTestHarness } from './test-dynamo-harness.js';

const TABLE_NAME = 'umine-voice-test-repositories';
let harness: DynamoTestHarness;
let doc: DynamoDBDocumentClient;

beforeAll(async () => {
  harness = await startDynamoTestHarness(TABLE_NAME);
  doc = harness.doc;
});
